...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/openssl-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/openssl-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libopenssl-static openssl
# for installing globally
pixi global install libopenssl-static openssl
```
...
It is possible to list all of the versions of `libopenssl-static` available on your platform:
...
```
pixi search libopenssl-static --channel conda-forge
```
